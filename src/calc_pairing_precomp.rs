...
>(
    ...
    for i in 0..12 {
        for j in 0..12 {
            if j == 0 {
                let mul_tmp1 = builder.mul_extension(bit_selector , local_values[start_col + SELECTOR_OFFSET + i]);
    ...
    for j in 0..24 {
        let mul_tmp1 = builder.mul_extension(bit_selector, local_values[start_col + MULTIPLICATION_FIRST_ROW_OFFSET]);
...
>(
    ...
    for j in 0..24 {
        if j == 0 {
            let mul_tmp1 = builder.mul_extension(bit_selector , local_values[start_col + ADDITION_CHECK_OFFSET]);
...
>(
    ...
    add_addition_constraints_ext_circuit(builder, yield_constr, local_values, next_values, start_col, bit_selector);
    let mod_u32 = get_u32_vec_from_literal(modulus());
...
>(
    ...
    for j in 0..12 {
        if j == 0 {
            let mul_tmp1 = builder.mul_extension(bit_selector , local_values[start_col + FP_MULTIPLY_SINGLE_CHECK_OFFSET]);
...
>(
    ...
    for i in 0..12 {
        ...
        let mul_tmp1 = builder.mul_extension(bit_selector, local_values[start_col + FP_SINGLE_REDUCE_MULTIPLICATION_OFFSET + FP_MULTIPLY_SINGLE_CHECK_OFFSET]);
    ...
    add_fp_single_multiply_constraints_ext_circuit(builder, yield_constr, local_values, next_values, start_col+FP_SINGLE_REDUCE_MULTIPLICATION_OFFSET, bit_selector);

    for i in 0..12 {
        let mul_tmp1 = builder.mul_extension(bit_selector , local_values[start_col + FP_SINGLE_REDUCTION_ADDITION_OFFSET + FP_ADDITION_CHECK_OFFSET]);
    ...
    add_addition_fp_constraints_ext_circuit(builder, yield_constr, local_values, next_values, start_col + FP_SINGLE_REDUCTION_ADDITION_OFFSET, bit_selector);
...
>(
    ...
    add_addition_fp_constraints_ext_circuit(builder, yield_constr, local_values, next_values, start_col + FP2_ADDITION_0_OFFSET, bit_selector);
    add_addition_fp_constraints_ext_circuit(builder, yield_constr, local_values, next_values,start_col + FP2_ADDITION_1_OFFSET, bit_selector);
}
...
>(
    ...
    add_subtraction_fp_constraints_ext_circuit(builder, yield_constr, local_values, next_values, start_col + FP2_SUBTRACTION_0_OFFSET, bit_selector);
    add_subtraction_fp_constraints_ext_circuit(builder, yield_constr, local_values, next_values,start_col + FP2_SUBTRACTION_1_OFFSET, bit_selector);
}
...
>(
    ...
    add_fp_single_multiply_constraints_ext_circuit(builder, yield_constr, local_values, next_values, start_col + FP2_MULTIPLY_SINGLE_0_OFFSET, bit_selector);
    add_fp_single_multiply_constraints_ext_circuit(builder, yield_constr, local_values, next_values,start_col + FP2_MULTIPLY_SINGLE_1_OFFSET, bit_selector);
}
...
>(
    ...
    for j in 0..24 {
        if j == 0 {
            let mul_tmp1 = builder.mul_extension(bit_selector , local_values[start_col + SUBTRACTION_CHECK_OFFSET]);
    ...
    P: PackedField<Scalar = FE>,
{
    ...
    for i in 0..12 {
        ...
        yield_constr.constraint(
            bit_selector * local_values[start_col + RANGE_CHECK_SELECTOR_OFFSET] * (val_reconstructed - local_values[start_col + RANGE_CHECK_SUM_OFFSET + 11])
        );
        yield_constr.constraint(bit_selector * local_values[start_col + RANGE_CHECK_SELECTOR_OFFSET] * local_values[bit_col + 30]);
    }
}
...
>(
    ...
    for i in 0..12 {
        ...
        let mul_tmp1 = builder.mul_extension(bit_selector , local_values[selector_col]); 
    ...
    for i in 0..24 {
        let mul_tmp1 = builder.mul_extension(bit_selector, local_values[start_col + REDUCTION_ADDITION_OFFSET + ADDITION_CHECK_OFFSET]);
    ...
    add_addition_constraints_ext_circuit(builder, yield_constr, local_values, next_values, start_col + REDUCTION_ADDITION_OFFSET, bit_selector);
    ...
    P: PackedField<Scalar = FE>,
{
    ...
    for i in 0..24 {
        yield_constr.constraint_transition(bit_selector *
...
>(
    ...
    for i in 0..24 {
        let mul_tmp1 = builder.mul_extension(bit_selector, local_values[start_col + Z1_ADD_MODULUS_OFFSET + ADDITION_CHECK_OFFSET]);
    ...
    add_addition_constraints_ext_circuit(builder, yield_constr, local_values, next_values, start_col + Z1_ADD_MODULUS_OFFSET, bit_selector);

    for i in 0..24 {
        let mul_tmp1 = builder.mul_extension(bit_selector, local_values[start_col + Z1_SUBTRACTION_OFFSET + SUBTRACTION_CHECK_OFFSET]);
    ...
    add_subtraction_constraints_ext_circuit(builder, yield_constr, local_values, next_values, start_col + Z1_SUBTRACTION_OFFSET, bit_selector);
    ...
    for i in 0..24 {
        let mul_tmp1 = builder.mul_extension(bit_selector, local_values[start_col + Z2_ADDITION_OFFSET + ADDITION_CHECK_OFFSET]);
    ...
    add_addition_constraints_ext_circuit(builder, yield_constr, local_values, next_values, start_col + Z2_ADDITION_OFFSET, bit_selector);
...
>(
    ...
    add_range_check_constraints_ext_circuit(builder, yield_constr, local_values, next_values, start_col + X0_Y_RANGECHECK_OFFSET, bit_selector);
    ...
    add_range_check_constraints_ext_circuit(builder, yield_constr, local_values, next_values, start_col + X1_Y_RANGECHECK_OFFSET, bit_selector);
}
...
>(
    ...
    for i in 0..12 {
        ...
        for i in 0..24 {
            ...
            let mul_tmp1 = builder.mul_extension(bit_selector, local_values[start_col + MULTIPLY_B_ADD_MODSQ_OFFSET + ADDITION_CHECK_OFFSET]);
        ...
        add_addition_constraints_ext_circuit(builder, yield_constr, local_values, next_values, start_col + MULTIPLY_B_ADD_MODSQ_OFFSET, bit_selector);
        add_subtraction_constraints_ext_circuit(builder, yield_constr, local_values, next_values, start_col + MULTIPLY_B_SUB_OFFSET, bit_selector);
        add_addition_constraints_ext_circuit(builder, yield_constr, local_values, next_values, start_col + MULTIPLY_B_ADD_OFFSET, bit_selector);
        for i in 0..24 {
        ...
        add_range_check_constraints_ext_circuit(builder, yield_constr, local_values, next_values, start_col + MULTIPLY_B_Z0_RANGECHECK_OFFSET, bit_selector);
...
>(
    ...
    add_range_check_constraints_ext_circuit(builder, yield_constr, local_values, next_values, start_col + FP2_ADDITION_TOTAL + FP2_SUBTRACTION_TOTAL + FP_SINGLE_REDUCE_TOTAL*2 + RANGE_CHECK_TOTAL, bit_selector);
}
...
>(
    ...
    for i in 0..12 {
        let mul_tmp1 = builder.mul_extension(bit_selector, local_values[start_col + FP2_ADDITION_1_OFFSET + FP_ADDITION_CHECK_OFFSET]);
...
impl<F: RichField + Extendable<D>, const D: usize> Stark<F, D> for PairingPrecompStark<F, D> {
        ...
        P: PackedField<Scalar = FE>,
    {
        ...
        add_fp2_mul_constraints(local_values, next_values,yield_constr, 0, P::ONES);
        ...
        add_fp2_mul_constraints(local_values, next_values,yield_constr, X_MULT_Z_INV_OFFSET, P::ONES);
        ...
        add_fp2_mul_constraints(local_values, next_values, yield_constr, Y_MULT_Z_INV_OFFSET, P::ONES);
        ...
        add_fp2_mul_constraints(local_values, next_values, yield_constr, T0_CALC_OFFSET, bit0);
        ...
        add_fp2_mul_constraints(local_values, next_values, yield_constr, T1_CALC_OFFSET, bit0);
        ...
        add_fp2_fp_mul_constraints(local_values, next_values, yield_constr, X0_CALC_OFFSET, bit0);
        ...
        add_multiply_by_b_constraints(local_values, next_values, yield_constr, T2_CALC_OFFSET, bit0);
        ...
        add_fp2_fp_mul_constraints(local_values, next_values, yield_constr, T3_CALC_OFFSET, bit0);
        ...
        add_fp2_mul_constraints(local_values, next_values, yield_constr, X1_CALC_OFFSET, bit0);
        ...
        add_fp2_fp_mul_constraints(local_values, next_values, yield_constr, T4_CALC_OFFSET, bit0);
        ...
        add_subtraction_with_reduction_constranints(local_values, yield_constr, X2_CALC_OFFSET, bit0);
        ...
        add_fp2_mul_constraints(local_values, next_values, yield_constr, X3_CALC_OFFSET, bit0);
        ...
        add_fp2_fp_mul_constraints(local_values, next_values, yield_constr, X4_CALC_OFFSET, bit0);
        ...
        add_negate_fp2_constraints(local_values, yield_constr, X5_CALC_OFFSET, bit0);
        ...
        add_subtraction_with_reduction_constranints(local_values, yield_constr, X6_CALC_OFFSET, bit0);
        ...
        add_fp2_mul_constraints(local_values, next_values, yield_constr, X7_CALC_OFFSET, bit0);
        ...
        add_fp2_mul_constraints(local_values, next_values, yield_constr, X8_CALC_OFFSET, bit0);
        ...
        add_addition_with_reduction_constranints(local_values, yield_constr, X9_CALC_OFFSET, bit0);
        ...
        add_fp2_fp_mul_constraints(local_values, next_values, yield_constr, X10_CALC_OFFSET, bit0);
        ...
        add_fp2_mul_constraints(local_values, next_values, yield_constr, X11_CALC_OFFSET, bit0);
        ...
        add_fp2_mul_constraints(local_values, next_values, yield_constr, X12_CALC_OFFSET, bit0);
        ...
        add_fp2_fp_mul_constraints(local_values, next_values, yield_constr, X13_CALC_OFFSET, bit0);
        ...
        add_fp2_fp_mul_constraints(local_values, next_values, yield_constr, NEW_RX_OFFSET, bit0);
        ...
        add_subtraction_with_reduction_constranints(local_values, yield_constr, NEW_RY_OFFSET, bit0);
    ...
    fn eval_ext_circuit(
        ...
        add_fp2_mul_constraints_ext_circuit(builder, yield_constr, local_values, next_values, 0, one);
        ...
        add_fp2_mul_constraints_ext_circuit(builder, yield_constr, local_values, next_values, X_MULT_Z_INV_OFFSET, one);
        ...
        add_fp2_mul_constraints_ext_circuit(builder, yield_constr, local_values, next_values, Y_MULT_Z_INV_OFFSET, one);
        ...
        add_fp2_mul_constraints_ext_circuit(builder, yield_constr, local_values, next_values, T0_CALC_OFFSET, bit0);
        ...
        add_fp2_fp_mul_constraints_ext_circuit(builder, yield_constr, local_values, next_values, X0_CALC_OFFSET, bit0);
        ...
        add_multiply_by_b_constraints_ext_circuit(builder, yield_constr, local_values, next_values, T2_CALC_OFFSET, bit0);
        ...
        add_fp2_fp_mul_constraints_ext_circuit(builder, yield_constr, local_values, next_values, T3_CALC_OFFSET, bit0);
        ...
        add_fp2_mul_constraints_ext_circuit(builder, yield_constr, local_values, next_values, X1_CALC_OFFSET, bit0);
        ...
        add_fp2_fp_mul_constraints_ext_circuit(builder, yield_constr, local_values, next_values, T4_CALC_OFFSET, bit0);
        ...
        add_subtraction_with_reduction_constraints_ext_circuit(builder, yield_constr, local_values, next_values, X2_CALC_OFFSET, bit0);
        ...
        add_fp2_mul_constraints_ext_circuit(builder, yield_constr, local_values, next_values, X3_CALC_OFFSET, bit0);
        ...
        add_fp2_fp_mul_constraints_ext_circuit(builder, yield_constr, local_values, next_values, X4_CALC_OFFSET, bit0);
        ...
        add_negate_fp2_constraints_ext_circuit(builder, yield_constr, local_values, next_values, X5_CALC_OFFSET, bit0);
        ...
        add_subtraction_with_reduction_constraints_ext_circuit(builder, yield_constr, local_values, next_values, X6_CALC_OFFSET, bit0);
        ...
        add_fp2_mul_constraints_ext_circuit(builder, yield_constr, local_values, next_values, X7_CALC_OFFSET, bit0);
        ...
        add_fp2_mul_constraints_ext_circuit(builder, yield_constr, local_values, next_values,X8_CALC_OFFSET, bit0);
        ...
        add_addition_with_reduction_constraints_ext_circuit(builder, yield_constr, local_values, next_values, X9_CALC_OFFSET, bit0);
        ...
        add_fp2_fp_mul_constraints_ext_circuit(builder, yield_constr, local_values, next_values, X10_CALC_OFFSET, bit0);
        ...
        add_fp2_mul_constraints_ext_circuit(builder, yield_constr, local_values, next_values, X12_CALC_OFFSET, bit0);
        ...
        add_fp2_fp_mul_constraints_ext_circuit(builder, yield_constr, local_values, next_values, X13_CALC_OFFSET, bit0);
        ...
        add_fp2_fp_mul_constraints_ext_circuit(builder, yield_constr, local_values, next_values, NEW_RX_OFFSET, bit0);
        ...
        add_subtraction_with_reduction_constraints_ext_circuit(builder, yield_constr, local_values, next_values, NEW_RY_OFFSET, bit0);
        ...
        add_fp2_mul_constraints_ext_circuit(builder, yield_constr, local_values, next_values, NEW_RZ_OFFSET, bit0);
        ...
        add_fp2_mul_constraints_ext_circuit(builder, yield_constr, local_values, next_values, BIT1_T0_CALC_OFFSET, bit1);
        ...
        add_subtraction_with_reduction_constraints_ext_circuit(builder, yield_constr, local_values, next_values, BIT1_T1_CALC_OFFSET, bit1);
        ...
        add_fp2_mul_constraints_ext_circuit(builder, yield_constr, local_values, next_values, BIT1_T2_CALC_OFFSET, bit1);
        ...
        add_fp2_mul_constraints_ext_circuit(builder, yield_constr, local_values, next_values, BIT1_T4_CALC_OFFSET, bit1);
        ...
        add_fp2_mul_constraints_ext_circuit(builder, yield_constr, local_values, next_values, BIT1_T5_CALC_OFFSET, bit1);
        ...
        add_subtraction_with_reduction_constraints_ext_circuit(builder, yield_constr, local_values, next_values, BIT1_T6_CALC_OFFSET, bit1);
        ...
        add_negate_fp2_constraints_ext_circuit(builder, yield_constr, local_values, next_values, BIT1_T7_CALC_OFFSET, bit1);
        ...
        add_fp2_mul_constraints_ext_circuit(builder, yield_constr, local_values, next_values,BIT1_T8_CALC_OFFSET, bit1);
        ...
        add_fp2_mul_constraints_ext_circuit(builder, yield_constr, local_values, next_values, BIT1_T9_CALC_OFFSET, bit1);
        ...
        add_fp2_mul_constraints_ext_circuit(builder, yield_constr, local_values, next_values, BIT1_T10_CALC_OFFSET, bit1);
        ...
        add_fp2_mul_constraints_ext_circuit(builder, yield_constr, local_values, next_values, BIT1_T11_CALC_OFFSET, bit1);
        ...
        add_fp2_mul_constraints_ext_circuit(builder, yield_constr, local_values, next_values, BIT1_T12_CALC_OFFSET, bit1);
        ...
        add_fp2_fp_mul_constraints_ext_circuit(builder, yield_constr, local_values, next_values, BIT1_T13_CALC_OFFSET, bit1);
        ...
        add_subtraction_with_reduction_constraints_ext_circuit(builder, yield_constr, local_values, next_values, BIT1_T14_CALC_OFFSET, bit1);
        ...
        add_addition_with_reduction_constraints_ext_circuit(builder, yield_constr, local_values, next_values, BIT1_T15_CALC_OFFSET, bit1);
        ...
        add_subtraction_with_reduction_constraints_ext_circuit(builder, yield_constr, local_values, next_values, BIT1_T16_CALC_OFFSET, bit1);
        ...
        add_fp2_mul_constraints_ext_circuit(builder, yield_constr, local_values, next_values, BIT1_T17_CALC_OFFSET, bit1);
        ...
        add_fp2_mul_constraints_ext_circuit(builder, yield_constr, local_values, next_values, BIT1_T18_CALC_OFFSET, bit1);
        ...
        add_fp2_mul_constraints_ext_circuit(builder, yield_constr, local_values, next_values, BIT1_RX_CALC_OFFSET, bit1);
        ...
        add_subtraction_with_reduction_constraints_ext_circuit(builder, yield_constr, local_values, next_values, BIT1_RY_CALC_OFFSET, bit1);
        ...
        add_fp2_mul_constraints_ext_circuit(builder, yield_constr, local_values, next_values, BIT1_RZ_CALC_OFFSET, bit1);
