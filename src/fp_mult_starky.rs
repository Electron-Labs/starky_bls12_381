...
use crate::native::{get_u32_vec_from_literal_24, get_selector_bits_from_u32, multiply_by_slice, add_u32_slices};
...
mod tests {
    ...
    use crate::{native::get_u32_vec_from_literal_24, fp_mult_starky::FpMultiplicationStark};
