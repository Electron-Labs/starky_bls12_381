...
impl<F: RichField + Extendable<D>, const D: usize> FinalExponentiateStark<F, D> {
    ...
    pub fn generate_trace(&mut self, x: Fp12) {
        ...
        let t6 = self.fill_trace_cyc_sq(&t3, T6_ROW, T7_ROW-1, FINAL_EXP_T6_OFFSET);
        ...
        let t10 = self.fill_trace_conjugate(&t9, T10_ROW, FINAL_EXP_T10_OFFSET);
        let t11 = self.fill_trace_cyc_exp(&t10, T11_ROW, T12_ROW-1, FINAL_EXP_T11_OFFSET);
        let t12 = self.fill_trace_conjugate(&t11, T12_ROW, FINAL_EXP_T12_OFFSET);
        let t13 = self.fill_trace_cyc_exp(&t12, T13_ROW, T14_ROW-1, FINAL_EXP_T13_OFFSET);
        let t14 = self.fill_trace_conjugate(&t13, T14_ROW, FINAL_EXP_T14_OFFSET);
        let t15 = self.fill_trace_cyc_sq(&t5, T15_ROW, T16_ROW-1, FINAL_EXP_T15_OFFSET);
        let t16 = self.fill_trace_mul(&t14, &t15, T16_ROW, T17_ROW-1, FINAL_EXP_T16_OFFSET);
        let t17 = self.fill_trace_cyc_exp(&t16, T17_ROW, T18_ROW-1, FINAL_EXP_T17_OFFSET);
        let t18 = self.fill_trace_conjugate(&t17, T18_ROW, FINAL_EXP_T18_OFFSET);
        let t19 = self.fill_trace_mul(&t5, &t12, T19_ROW, T20_ROW-1, FINAL_EXP_T19_OFFSET);
        let t20 = self.fill_trace_forbenius(&t19, 2, T20_ROW, T21_ROW-1, FINAL_EXP_T20_OFFSET);
        let t21 = self.fill_trace_mul(&t10, &t3, T21_ROW, T22_ROW-1, FINAL_EXP_T21_OFFSET);
        let t22 = self.fill_trace_forbenius(&t21, 3, T22_ROW, T23_ROW-1, FINAL_EXP_T22_OFFSET);
        let t23 = self.fill_trace_conjugate(&t3, T23_ROW, FINAL_EXP_T23_OFFSET);
        let t24 = self.fill_trace_mul(&t16, &t23, T24_ROW, T25_ROW-1, FINAL_EXP_T24_OFFSET);
        let t25 = self.fill_trace_forbenius(&t24, 1, T25_ROW, T26_ROW-1, FINAL_EXP_T25_OFFSET);
        let t26 = self.fill_trace_conjugate(&t8, T26_ROW, FINAL_EXP_T26_OFFSET);
        let t27 = self.fill_trace_mul(&t18, &t26, T27_ROW, T28_ROW-1, FINAL_EXP_T27_OFFSET);
        let t28 = self.fill_trace_mul(&t27, &t3, T28_ROW, T29_ROW-1, FINAL_EXP_T28_OFFSET);
        let t29 = self.fill_trace_mul(&t20, &t22, T29_ROW, T30_ROW-1, FINAL_EXP_T29_OFFSET);
        let t30 = self.fill_trace_mul(&t29, &t25, T30_ROW, T31_ROW-1, FINAL_EXP_T30_OFFSET);
        let t31 = self.fill_trace_mul(&t30, &t28, T31_ROW, TOTAL_ROW-1, FINAL_EXP_T31_OFFSET);
    }
}
